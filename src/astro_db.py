...
class AstroDB:
	...
	def insert_comment_dataframe(self, video_id: str, dataframe: pd.DataFrame):
		...
		dataframe.to_sql(comment_table, self.conn, if_exists='replace') # eventually, I'll want to append here
...
def main():
	...
	db.insert_comment('4M-FeqYmwdg', 'acullar', 'hello there', '8.2.1993') 
